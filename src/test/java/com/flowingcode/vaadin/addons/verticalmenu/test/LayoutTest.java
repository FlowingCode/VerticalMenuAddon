 ...
 * #L%
 */
package com.flowingcode.vaadin.addons.verticalmenu.test;
...
import com.flowingcode.vaadin.addons.verticalmenu.VerticalmenuDemoView;
...
public class LayoutTest {
	...
	public void testDemoLayout() {
		Route route = VerticalmenuDemoView.class.getAnnotation(Route.class);
