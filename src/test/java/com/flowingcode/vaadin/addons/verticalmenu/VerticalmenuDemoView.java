...
public class VerticalmenuDemoView extends VerticalMenu {
	...
	public VerticalmenuDemoView() {
		super(new Section(new H1("Inbox"), createDummyInbox()), new Section(new H1("Profile")),
				new Section(new H1("Friends")), new Section(new H1("Messages")), new Section(new H1("Settings")));
